...
public class HealthVisitor extends Person {
	...
	/* Constructor */
	public HealthVisitor(String location, String password, String username, String name, String surname,
			String namesuffix, LocalDate birthday, Address address) {
