...
public class Calendar {
    ...
    public Appointment getRecentAppointment() {
        Appointment recentAppointment = new Appointment(), appointment = null;
        for (int i = 0, appointmentsSize = appointments.size(); i < appointmentsSize; i++) {
            appointment = appointments.get(i);
            recentAppointment = appointment.getStart().isAfter(appointments.get(i - 1).getStart()) ? appointment : null;
        }
